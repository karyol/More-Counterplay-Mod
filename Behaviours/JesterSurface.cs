...
namespace MoreCounterplay.Behaviours
{
    ...
    public class JesterSurface : PlaceableObjectsSurface
    {
        ...
        public void PlaceItemOnClient(GrabbableObject item)
        {
            ...
            if (parentTo == null || placeableBounds == null || triggerScript == null)
                return;
        ...
        {
            if (playerReference.TryGet(out NetworkObject playerNetworkObject) && playerNetworkObject.IsOwner)
                return;
